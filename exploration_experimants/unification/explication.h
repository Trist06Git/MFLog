...
bool rec_explic_func_expr(expr*, int* unique, vector* fcs_to_move, vector* singletons, vector* func_defs, function* root);
...
vector* get_var_singles(function*, vector*, bool globals);///maybe move this to utils or internal_struct
vector* get_var_singles_e(expr*);
vector* extract_singles_map(map*);
void rec_get_var_singles_e(expr*, vector* fc_to_move, map*);
