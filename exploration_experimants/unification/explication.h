...
void rec_explic_func_expr(expr*, int* unique, vector* fcs_to_move, vector* singletons, vector* func_defs);
void rec_explic_func_equ(expr*, int* unique, vector* fc_to_move, vector* singles, vector* func_defs);
void explic_func_params(fcall*, int* unique, vector* fcs_to_move, vector* singletons, vector* func_defs);
